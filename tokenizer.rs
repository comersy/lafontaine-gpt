...
// Reads all .txt files from Data - French and Data - Fables
// Outputs tokenizer.json compatible with tokenizer.py
//
// Compile: rustc -O tokenizer.rs -o tokenizer_train
// Run:     ./tokenizer_train --vocab_size 32000 --min_freq 2
...
fn train_bpe(
    ...
    println!("  {} base tokens ===> {} merges to learn\n", vocab_tokens.len(), n_merges);
...
fn save_tokenizer(
    ...
    println!("Tokenizer saved ===> {} ({} tokens)", path, vocab_tokens.len());
}
